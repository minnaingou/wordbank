...
const About = () => {
  return (
    <Stack direction="column" spacing={2} alignItems="center" pt={5} pb={10}>
      <img
      ...
      <div style={{ paddingLeft: 45, paddingRight: 45 }}>
        ...
        <div style={{ border: "1px solid black" }}>
          <Typography variant="body2" gutterBottom m={2}>
            WordBank is not just another dictionary app. So what is it? <br />
            <br />
            Have you ever come across an unfamiliar word and looked it up in a
            dictionary, only to forget it a few moments later? <br />
            <br />
            WordBank is an app to help you with that. With WordBank, you can
            lookup a word and save it to your favourite list along with the
            example usages and your own notes. <br />
            You can easily review them later in the Practice session where you
            will be presented with flashcards created from your favourites.
            <br />
            <br />
            WordBank helps you memorize new words by prioritizing the words you
            just added, or the words you are having a hard time remembering
            before those which are more frequently reviewed, and are remembered
            well.
          </Typography>
        </div>
        <Typography
        ...
        <div style={{ border: "1px solid black" }}>
          <Typography variant="body2" gutterBottom m={2}>
            ...
            modern frontend frameworks. I recently started exploring React and
        ...
        <div style={{ border: "1px solid black" }}>
          <Typography variant="body2" gutterBottom m={2}>
            React, react-redux, redux-thunk middleware, react-router,
            material-ui, react-card-flip, axios and Firebase for backend. Free
